...
function diplayModal(index) {
    let { name, dob, phone, email, location: { city, street, state, postcode}, picture } = employee[index];
    ...
    const modalHTML = `
        ...
        <div class="text-container">
            ...
            <hr>
            <p>${phone}</p>
            <p class="address">${date.getMonth()}/${date.getDate()}/${date.getFullYear()}</p>
    `;
